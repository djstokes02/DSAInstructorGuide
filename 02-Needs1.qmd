...
You will be added to a chat group through your NCSU credentials - [DSA Instructors Group - Spring 2026](https://chat.google.com/room/AAQA-rEg4KQ?cls=7). 
...
For updates and reminders, please acknowledge receipt with a "thumbs up", or another response.
 
### Student Work Collection

As part of the DSA mission to provide excellent learning opportunities, we collect data to assess our offerings and learning approach. The purpose of the data collection is to evaluate the DSA and how well we are serving our students so that informed adjustments and improvements can be made. In addition we may plan to share what we learn with other universities and researchers. For this process, students will be asked for their consent to data collection/research participation at the beginning of the course in terms of the use of their de-identified data and the related work of the DSA.
...
:::
 ...
 - NOTE: To facilitate student work collection, please use the following `naming conventions`, `course_section_semester_assignment_unityID`, where course is the 3 digit prefix and number, section is the three digit section number, semester is FA (Fall) or SP (Spring) followed by the last two digits of the year, A is for assignments and FP is for final project. The unityID is for the student whose work is being collected - each student has a unique unityID. Examples below. Note: If students turn in group assignments, adjustments may be needed.
   ...
   - `DSA201_001_FA25_A1_djstokes`
  
   - `DSA495_601_SP26_FP_unityID`
  
   - `DSA412_011_FA26_A5_unityID`
...
[Course Collaboration Leaders Support & More](https://datascienceacademy.ncsu.edu/courses/course-collaboration-leaders/)

The website link includes Course Collaboration Leaders (CCLs) peer-support office hours, as well as other recommendations for student support. The CCLs are typically available on a daily basis according to the schedule provided. They offer support to their peers in online and in person spaces as indicated in the website link. 
...
For online courses: [How To Retrieve Meeting Attendance on Zoom](https://drive.google.com/file/d/19vuYwyGcMrrBjQVzWbaDph1aHUR7u2bu/view?usp=drive_link) (from Dr. Jamie Harr).
 ...
 - Please communicate to students why attendance is important. For example, collaboration and discussion are expectations for data scientists and individuals working within related fields/titles and is a part of workforce preparedness. These aspect are likely an integral part of your course as well, so students should know that this is an expectation and should plan to attend with the intent to participate in discussions and collaborations.
 
 - For online courses, it may be useful to establish classroom expectations that students keep their cameras on, whenever possible, as part of the course engagement and workforce preparedness process.
...
### Instructor Communication
 ...
 As an instructor, you are expected to notify the Director of Teaching and Learning of attendance conflicts. This includes:
...
Learning Technologies support can be sought through [DELTA](https://delta.ncsu.edu/learntech-request/). However, you are encouraged to post questions to the [instructor group chat space](https://chat.google.com/room/AAQANL1f7qc?cls=7) where others may be able to help you sooner and/or may have the same or similar questions. Email is fine too.
