...
\item
  Send out { \textbf{DSA Course Feedback Questionnaire: Part 1 of 3} } (Provide your students with the link here: \url{https://forms.gle/wKUukPR1b1CxKMkW6}).
\end{enumerate}
...
\item
  Notify students about the \textbf{Course Collaboration Leaders Support, Six Ways to Get Help} \href{https://docs.google.com/document/d/1ZNli1SdLy-AdxarjaNLSRpQOmh9q9KsAvqzWCcb_Wrg/edit?usp=sharing}{(Linked Here)} resource, and add this to your moodle page/course management system.
\item
...
\tightlist
\item
  Send out { \textbf{DSA Course Feedback Questionnaire: Part 2 of 3} } (Provide your students with the link here: \url{https://forms.gle/UxQ4z9GFTGhPVmec9}).
\end{enumerate}
...
\tightlist
\item
  Send out { \textbf{DSA Course Feedback Questionnaire: Part 3 of 3} } (link provided to you).
\end{enumerate}
...
{ Complete the following form: } \href{https://forms.gle/7yiAckCrq53vqdut8}{Instructor Course and Work Collection Documentation - Spring 2024}
...
\hypertarget{delta-resources-for-moodle}{%
